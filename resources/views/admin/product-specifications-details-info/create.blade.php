...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{ route('product-specification-info.store') }}"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add Product
                                    Specification Details info</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{ route('product-specification-info.index') }}"
                                   class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                        class="fas fa-th label-icon"></i>All Product Specification Details info</a>
                            </div>
