    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All weight Info</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href='{{ route("weight-info.create") }}' class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add weight Info</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      @foreach($weightInfos as $data)
                      <tr>
                          <td>{{ $data->weight ?: '' }}</td>
                          <td>{{ isset($data->weightType) ? $data->weightType->name : '' }}</td>
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{ route('weight-info.edit',$data->id) }}">Edit</a>
