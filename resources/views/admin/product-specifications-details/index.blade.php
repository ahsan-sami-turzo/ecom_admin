        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header card_header">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All Product Specification Details</h4>
                        </div>
                        <div class="col-md-4 text-right">
                            <a href='{{ route("product-specification-details.create") }}'
                               class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                    class="fas fa-plus-circle label-icon"></i>Add product specification details</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table id="alltableinfo"
                        ...
                        <tbody>
                        @foreach($productSpecificationDetails as $data)
                            <tr>
                                <td>{{ isset($data->category) ? $data->category->category_name : '' }}</td>
                                <td>
                                    @isset($data->specification_details_name)
                                        @foreach(json_decode($data->specification_details_name)  as $key => $val )
                                            <li>{{ $val }}</li>
                                        @endforeach
                                    @endisset
                                </td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item"
                                               href="{{ route('product-specification-details.edit',$data->id) }}">Edit</a>
