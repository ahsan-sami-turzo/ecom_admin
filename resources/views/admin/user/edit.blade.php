                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Name<span class="req_star">*</span>:</label>
                            <div class="col-sm-7">
...
{{--                        </div>--}}
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('password') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Password<span class="req_star">*</span>:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Confirm-Password<span class="req_star">*</span>:</label>
                            <div class="col-sm-7">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('roles') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-7">
                                ...
                                <select class="form-control select2 form_control" name="roles[]" multiple>
                                    @foreach ( $roles as $role => $value)
                                        <option value="{{ $role }}" {{ in_array($role, $userRole) ? 'selected' : ''}} > {{ $value }}</option>
                                    @endforeach
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('user_type') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Approved User {{ $user->user_type }}<span class="req_star">*</span>:</label>
                            <div class="col-sm-7">
                                <input style="margin-top: 11px;" type="checkbox" name="user_type" checked  {{--{{ !empty($user->user_type) ? 'checked' : '' }}--}} value="1">
