...
{{--                            <th>Status</th>--}}
                        ...
                        @if(count($vendor->vendorProducts) > 0)
                            @foreach($vendor->vendorProducts as $data)
                                <tr>
                                    <td>{{ $data->product_name ?? '' }}</td>
                                    <td><img src="{{ asset("uploads/product/optimize/$data->home_image") }}" alt="">
                                    </td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item"
                                                   href="{{ route('products.show',$data->id) }}">View</a>
                                                <a class="dropdown-item"
                                                   href="{{ route('products.edit',$data->id) }}">Edit</a>
