            ...
            <form method="post" action="{{ route('brand.store') }}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add brand</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{ route('brand.index') }}"
                                   class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                        class="fas fa-th label-icon"></i>All brand </a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Brand name<span class="req_star ">*</span></label>
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Website / Facebook page url<span class="req_star ">*</span></label>
                            <label class="col-sm-1 mt-2 text-center">:</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('user_id') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left">User name<span class="req_star ">*</span></label>
                            <label class="col-sm-1 mt-2 text-center">:</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('image') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Product Feature Image<span class="req_star ">*</span></label>
                            <label class="col-sm-1 mt-2 text-center">:</label>
                            <div class="col-sm-4">
