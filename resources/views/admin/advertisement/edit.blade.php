            ...
            <form method="post" action="{{ route('advertisement.update',$advertisement->id) }}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Update advertisement</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{ route('advertisement.index') }}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-th label-icon"></i>All advertisement</a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            <label class="col-sm-3 col-form-label col_form_label">advertisement name</label>
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control form_control @error('name') is-invalid @enderror"
                                       name="name" value="{{old('name',$advertisement->name)}}">
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-4">
                                <textarea class="form-control form_control @error('description') is-invalid @enderror"
                                          name="description" >{{old('description',$advertisement->description)}}</textarea>
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-4">
                                ...
                                @endif
                                <img style="height: 80px; margin-top: 10px" id="img-upload-one" @if(isset($advertisement->image)) src='{{ asset("uploads/advertisement/$advertisement->image") }}' @endif/>
                            </div>
                        </div>
