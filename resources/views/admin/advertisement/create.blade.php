            ...
            <form method="post" action="{{ route('advertisement.store') }}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add advertisement</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{ route('advertisement.index') }}"
                                   class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                        class="fas fa-th label-icon"></i>All advertisement </a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('image') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label">Advertisement Image</label>
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-4">
