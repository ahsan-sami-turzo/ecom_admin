            ...
            <form method="post" action="{{route('discounts.store')}}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add Discount
                                </h4>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('vendor_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control select2 vendors " id="vendorsID" name="vendor_id[]" multiple>
                                    @foreach ($vendors as $vendor)
                                        <option class="custom-style" value="{{ $vendor->id}}" style="font-weight: 900 !important; display: block !important; "> {{  $vendor->name }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('category_id') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left"> Category name<span
                                    class="req_star">*</span>:</label>
                            <div class="col-sm-6">
                                <select class="form-control select2 category" id="categoryId" name="category_id[]" multiple>
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('percentage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-3">
                                <select class ="form-control " id ="discount_type" name="discount_type">
                                    ...
                                    <option class="custom-style" value="amount" style="font-weight: 500 !important; "> Amount</option>
                                </select>
                            ...
                            <div class="col-sm-2">
                                <input type="number" id="discountNum" autocomplete="off" class="form-control form_control" name=""
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('percentage') ? ' has-error' : '' }}">
                            ...
                            <div class="col-3">
                                <select class ="form-control " id ="delivery_type" name="delivery_type">
                                    ...
                                    <option class="custom-style" value="delivery_free" style="font-weight: 500 !important; "> Free</option>
                                    <option class="custom-style" value="delivery_amount" style="font-weight: 500 !important; "> Delivery amount</option>
                                </select>
                                @if ($errors->has('discount_type'))
                                    <span class="invalid-feedback" role="alert">
                                     <strong>{{ $errors->first('discount_type') }}</strong>
                            ...
                            <div class="col-sm-2">
                                <input type="number" id="deliveryAmount" autocomplete="off" class="form-control form_control d-none" name=""
