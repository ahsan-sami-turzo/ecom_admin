...
@section('content')
    <form action='{{ route("purchase.store") }}' method="post" class="dropzone" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('totalQuantity') ? ' has-error' : '' }}">
                            ...
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-6">
                                <input readonly id="totalQuantity" type="text" autocomplete="off" class="form-control form_control"
                                       name="totalQuantity"
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('totalAmount') ? ' has-error' : '' }}">
                            ...
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-6">
                                <input id="totalAmount" disabled  type="text" autocomplete="off" class="form-control form_control"
                            ...
                            <tbody>
                                <tr class="addRowTr">
                                    <td class="text-center" style="width: 25%">
                                        <select class="form-control product-name product select2" id="productId"  name="product_id[]">
                                    ...
                                    <td class="text-center" style="width: 5%"><input style="height: 28px; padding: 0;" type="text" autocomplete="off" class="form-control form_control productQuantity" id="productQuantity"
                                                                 name="productQuantity[]"
                                                                 value='{{ old("productQuantity") }}' oninput="calculate('productQuantity','productPrice','totalPrice')"></td>
                                    <td class="text-center"  style="width: 10%"><input id="productPrice" style="height: 28px; padding: 0;" type="text" autocomplete="off" class="form-control form_control productPrice"
                                                                  name="productPrice[]"
                                                                  value='{{ old("productPrice") }}' oninput="calculate('productQuantity','productPrice','totalPrice')"></td>
                                    <td class="text-center"><input disabled id="totalPrice" style="height: 28px; padding: 0;" type="text" autocomplete="off" class="form-control form_control totalPrice"
                                               name="totalPrice[]"
                                               value='{{ old("totalPrice") }}' ></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-dark btn-sm" id="addRowBtn" type="button" ><i style="font-size: 14px" class="mdi mdi-plus"></i></button>
                                        </div>
                                    </td>
                                </tr>
...
<select class="form-control product-name product " id="productId` + i + `"  name="product_id[]">
                ...
                <td class="text-center" style="width: 15%">
                    <select class="form-control color-name" id="colorId`+i+`" name="color_id[]">
                        <option value="0">Color name</option>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            if(jQuery.inArray(color_names)) {
                                              ...
                                              let rr =  $("#colorId1").append(html_color_names);
                                                console.log(rr);
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            if(jQuery.inArray(size_types)) {
                                                ...
                                                $("#sizeId"+i).append(html_size_types);
                                            }
                                        },
                                    });
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            if(jQuery.inArray(weight_types)) {
                                                ...
                                                $("#weightId"+i).append(html_weight_types);
                                            }
                                        },
                                    });
                                });
