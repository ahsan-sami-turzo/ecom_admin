                        ...
                        <table id="alltableinfo"
                            ...
                            <tr class="addRowTr">
                                ...
                                <td id="td_show_weight" class="text-center hide-th-td" style="width: 12%">
                                    <select class="form-control weight-name select-box" name="weight_id[]" id="weightId">
...
/*
                                ...
                                $("#alltableinfo tbody tr:last").find(".product-name").attr('name', 'product_id[]');
                                $("#alltableinfo tbody tr:last").find(".color-name").attr('name', 'color_id[]');
                                $("#alltableinfo tbody tr:last").find(".size-name").attr('name', 'size_id[]');
                                $("#alltableinfo tbody tr:last").find(".weight-name").attr('name', 'weight_id[]');
*/
                                ...
                                // var html_color_names = `<input name="color_id[]" hidden value="0">`;
                                // $('#td_show_color').append(html_color_names);
