            ...
            <form method="post" action="{{route('category.store')}}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add category
                                </h4>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('description') ? ' has-error' : '' }}">
                            <label class="col-sm-3 col-form-label col_form_label text-left">Description<span class="req_star">*</span>:</label>
                            <div class="col-sm-7">
                            ...
                            <div class="col-sm-7">
                                <select class ="form-control select2" id ="parentId" name="parent_category_id">
                                        ...
                                        @foreach ($categories as $category)
                                                <option class="custom-style" value="{{ $category->id}}" style="font-weight: 900 !important; display: block !important; " data-style="background-color: #000000;"><?= str_repeat("&nbsp; ", $category->level).'-'?> {{  $category->category_name}}</option>
               ...
               // $("#isSize").attr('checked', false);
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.success.is_color == 1) {
