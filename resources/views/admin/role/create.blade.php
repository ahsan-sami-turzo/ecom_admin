            ...
            <div class="card-header card_header">
                <div class="row">
                    ...
                    <div class="col-md-4 text-right">
                        <a href="{{ route('roles.index') }}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-th label-icon"></i>All Roles</a>
                    </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-3">
                ...
                <div class="form-group row mb-3 {{ $errors->has('permission') ? ' has-error' : '' }}">
                    <label class="col-sm-3 col-form-label col_form_label text-left">Permission Name<span class="req_star">*</span>:</label>
                    <div class="col-sm-7">

                        @foreach($permissions as $value)
                            <input style="margin-right: 5px" name="permission[]" value="{{ $value->id }}" type="checkbox">{{ $value->name ?:'' }} <br>
                        @endforeach
