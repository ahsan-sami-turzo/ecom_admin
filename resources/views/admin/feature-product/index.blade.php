    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All feature product</h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href='{{ route("feature-product.create") }}' class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add feature product</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      @foreach($featureProducts as $data)
                      <tr>
                          <td>{{ isset($data->featureName) ? $data->featureName->name : '' }}</td>
                          <td>
                              <ul style="margin-left: 20px">
                              @foreach($data->product as $value)
                                  <li style="list-style-type: disc">{{ $value->product_name }}</li>
                              @endforeach
                              </ul>
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{ route('feature-product.edit',$data->id) }}">Edit</a>
