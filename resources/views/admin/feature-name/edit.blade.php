...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{ route('feature-name.update',$feature_name->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <a href="{{ route('feature-name.index') }}" class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-th label-icon"></i>All Feature Name</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('display_products') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-4">
                                <select class ="form-control select2" id ="display_products" name="display_products">
                                    ...
                                    <option class="custom-style" value="7" style="font-weight: 900 !important; display: block !important; " {{ $feature_name->display_products == 7 ? 'selected' : ''	 }}>Feature Products</option>
                                    <option class="custom-style" value="5" style="font-weight: 900 !important; display: block !important; " {{ $feature_name->display_products == 5 ? 'selected' : ''	 }}>Slider Products</option>
                                    <option class="custom-style" value="3" style="font-weight: 900 !important; display: block !important; " {{ $feature_name->display_products == 3 ? 'selected' : ''	 }}>Selected Products</option>
                                    <option class="custom-style" value="2" style="font-weight: 900 !important; display: block !important; " {{ $feature_name->display_products == 2 ? 'selected' : ''	 }}>Special Products</option>
                                </select>
                        ...
                        <div class="form-group row mb-3 name" >
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control form_control @error('name') is-invalid @enderror"
                                       name="name" value="{{old('name',$feature_name->name ?: '')}}">
                                {{--@if ($errors->has('title'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div id="leftRight" class="d-none">
                            <div class="form-group row mb-3">
                                <label class="col-sm-4 col-form-label col_form_label text-left">Left Feature Name<span
                                        class="req_star">*</span>:</label>
                                <div class="col-sm-4">
{{--                                    <input disabled type="text" class="leftRightInput form-control form_control @error('display_type') is-invalid @enderror"--}}
...
{{--                                           name="display_type[]" value="{{old('display_type')}}">--}}
                        ...
                        <div id="displaySerial" class="form-group row mb-3  {{ $feature_name->display_products == 7 ? 'd-none' : '' }}">
                            ...
                            <div class="col-sm-4">
                                <input  type="text" class="displaySerial form-control form_control @error('display_serial') is-invalid @enderror"
                                        name="display_serial" value="{{old('display_serial',$feature_name->display_serial)}}">
                                {{--@if ($errors->has('title'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('title') }}</strong>
                                    </span>
