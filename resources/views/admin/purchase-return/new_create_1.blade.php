                        ...
                        <table id="alltableinfo"
                            ...
                            <!--                            <tr class="addRowTr">
                                <td class="text-center" style="width: 25%">
                                    <input class="form-control product-from-id"  name="product_entry_id[]"
                                           value=""/>
                                    <input class="form-control productId" value=""/>
                                    <input class="form-control product-from" id="productId"/>

                                </td>
                                <td class="text-center" style="width: 15%">
                                    <input class="form-control colorId" id=""/>
                                    <input class="form-control color-name" id="colorId"/>

                                </td>
                                <td class="text-center" style="width: 13%">
                                    <input class="form-control sizeId" name="size_id[]"/>
                                    <input class="form-control size-name" id="sizeId"/>
                                </td>
                                <td class="text-center" style="width: 12%">
                                    <input class="form-control weightId" name="weight_id[]"/>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".addRowTr").on('click',".removeRowBtn",function () {
                console.log('ok');
