                    ...
                    success: function (response) {
                        ...
                        if (jQuery.inArray(details_name)) {
                            ...
                            $.each(details_name, function (index, value) {
                                html_specification_details_names += `<option value="` + value.id + `">` + value.billNo + `</option>`;
                            });
                            $('#billNumbers').append(html_specification_details_names);
                        }
                    ...
                    success: function (response) {
                        ...
                        if (jQuery.inArray(purchaseDetails.purchase_details)) {
                            ...
                            $.each(purchaseDetails.purchase_details, function (index, value) {
                                html_specification_details_names += `<option value="` + value.id + `">` + value.product.product_name + `</option>`;
                            });
