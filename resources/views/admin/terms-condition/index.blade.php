    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header card_header">
                <div class="row">
                    <div class="col-md-8">
                        <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> All terms condition </h4>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href='{{ route("terms.create") }}' class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i class="fas fa-plus-circle label-icon"></i>Add terms condition</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table id="alltableinfo" class="table table-bordered table-striped table-hover dt-responsive nowrap custom_table">
                    ...
                    <tbody>
                      @foreach($termsConditions as $data)
                      <tr>
                          <td>{{ \Illuminate\Support\Str::words($data->terms_and_conditions,8,'...') ?: '' }}</td>
                          <td>{{ isset($data->condition) ? $data->condition->name : '' }}</td>
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{ route('terms.edit',$data->id) }}">Edit</a>
