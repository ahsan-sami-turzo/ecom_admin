...
@section('content')
    <div class="row">
        <div class="col-12">
            <form method="post" action="{{ route('campaign-offer.update',[$vendorDiscountCampaign->campaign_id,$vendorDiscountCampaign->id])}}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    ...
                    <div class="card-footer card_footer text-center">
                        <button type="submit" class="btn btn-md btn-success font-weight-bold">Update campaign</button>
                    </div>
                </div>
            </form>
        </div>
