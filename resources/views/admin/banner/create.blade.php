            ...
            <form method="post" action="{{ route('banner.store') }}" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header card_header">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title card_title"><i class="fab fa-gg-circle"></i> Add banner</h4>
                            </div>
                            <div class="col-md-4 text-right">
                                <a href="{{ route('banner.index') }}"
                                   class="btn btn-dark btn-md waves-effect btn-label waves-light card_btn"><i
                                        class="fas fa-th label-icon"></i>All banner </a>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-4">
                                <input type="date" class="form-control form_control @error('effective_from') is-invalid @enderror"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-4">
                                <input type="date" class="form-control form_control @error('effective_to') is-invalid @enderror"
