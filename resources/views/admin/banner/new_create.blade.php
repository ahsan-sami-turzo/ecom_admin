                    ...
                    <div id="product-entry-form" class="card-body d-none">
                        <table id="alltableinfo"
                            ...
                            <tr>
                                ...
                                <th id="th_show" class="text-center hide-th-td" colspan="3" style="width: 30%;">Specification</th>
                            ...
                            <tr class="addRowTr">
                                ...
                                <td id="td_show_weight" class="text-center hide-th-td" style="width: 12%">
                                    <select class="form-control weight-name select-box" id="weightId" name="weight_id[]">
