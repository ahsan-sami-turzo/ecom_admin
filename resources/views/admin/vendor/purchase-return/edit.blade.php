                                ...
                                @foreach($purchase->purchaseDetails as $purchaseDetail)
                                    <tr class="addRowTr">
                                        <td class="text-center" style="width: 25%">
                                            <select class="form-control <!--product-name product select2-->" id="productId"
                                                    name="product_id[]">
                                                <option value="">---Select product name---</option>
                                                @foreach($products->vendor->vendorProducts as $product)
                                                    <option value="{{ $product->id }}" selected {{ $product->id == $purchaseDetail->productId ? 'selected' : ''}}>{{ $product->product_name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <td class="text-center" style="width: 5%"><input
                                                ...
                                                oninput="calculate('productQuantity','productPrice','totalPrice')"></td>
