...
@section('content')
    <form action='{{ route("purchase-approved") }}' method="post" class="dropzone"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('vendor_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-6">
                                <input readonly class="form-control form_control"  value="{{ isset( $purchase->vendor) ? $purchase->vendor->name : ''}}">
                            </div>
                        </div>
                        @endrole
                        ...
                        <div class="form-group row mb-3 {{ $errors->has('vat_registration') ? ' has-error' : '' }}">
                            ...
                            <label class="col-sm-1 mt-2 text-center"><span class="req_star ">*</span>:</label>
                            <div class="col-sm-6">
                                <input readonly type="text" class="form-control form_control" value="{{old('vat_registration',$purchase->vat_registration)}}">
            ...
            <div class="col-12">
                <div class="card">
                                ...
                                @foreach($purchase->purchaseDetails as $purchaseDetail)
                                    <tr class="addRowTr">
                                        <td class="text-center" style="width: 25%">
                                            <input readonly class="form-control form_control " value="{{$purchaseDetail->product->product_name }}">
                                        </td>
                                        <td class="text-center" style="width: 15%">
                                            <input readonly class="form-control form_control " value="{{ isset($purchaseDetail->product->color) ? $purchaseDetail->product->color[0]->name : '' }}">
                                        </td>
                                        <td class="text-center" style="width: 13%">
                                            <input readonly class="form-control form_control " value="{{ isset($purchaseDetail->product->size) ? $purchaseDetail->product->size[0]->name : '' }}">

                                        </td>
                                        <td class="text-center" style="width: 12%">
                                            <input readonly class="form-control form_control " value="{{ isset($purchaseDetail->product->weight) ? $purchaseDetail->product->weight[0]->name : '' }}">
                                        </td>
                                        ...
                                        <td class="text-center"><input disabled id="totalPrice"
                                                                       ...
                                                                       value='{{ $purchaseDetail->price * $purchaseDetail->quantity }}'></td>
                    ...
                    <div class="card-footer card_footer text-center">
                        ...
                        <button {{ $purchase->is_approved == 1 ? 'disabled' :'' }}  type="{{ $purchase->is_approved == 1 ? 'button' :'submit' }}" class="btn btn-md {{ $purchase->is_approved == 1 ? 'btn-success' :'btn-info' }} ">{{ $purchase->is_approved == 1 ? 'Already stock added' :'Approved' }}</button>
                        @endif
