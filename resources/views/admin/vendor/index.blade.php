...
{{--                            {{ dd($user->getRoleNames()) }}--}}
                            <td>@if(!empty($vendor->getRoleNames()))
...
{{--                              @endif--}}
{{--                            </td>--}}
                            <td><label class="btn {{ $vendor->status == 'APPROVED' ? 'text-success' : 'text-danger'}}">{{ $vendor->status }}</label></td>
                            <td>
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href='{{route("user.edit",$vendor->id)}}'>Edit</a>
                                    <a class="dropdown-item" href="#" id="softDelete" title="delete" data-toggle="modal" data-target="#softDelModal" data-id="{{$vendor->id}}">Delete</a>
                                </div>
                              </div>
                            </td>
                        </tr>
